    ...
    public partial class UcXuatKho : UserControl
    {
        ...
        private void ReloadData()
        {
            ThreadHelper.LoadForm(() =>
            {
                ...
                _congNos = CRUD.DbContext.CongNoes.Where(s => s.LoaiDonHang == Define.LoaiDonHangEnum.XuatKho.ToString()).ToList();
        ...
        private void gridViewCongNo_DoubleClick(object sender, EventArgs e)
        {
            ThreadHelper.LoadForm(() =>
            {
                ...
                if (data != null && data.Id != null)
                {
                    ...
                    FormBehavior.GenerateForm(new UcCongNo(Define.LoaiDonHangEnum.XuatKho, info), "Công Nợ", this.ParentForm);
                }
            });
        }
